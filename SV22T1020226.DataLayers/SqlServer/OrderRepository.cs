...
using SV22T1020226.DataLayers.Interfaces;
using SV22T1020226.Models.Common;
using SV22T1020226.Models.Sales;
using System.Data;

namespace SV22T1020226.DataLayers.SqlServer
{
    /// <summary>
    ...
    public class OrderRepository : BaseSqlDAL, IOrderRepository
    {
        ...
        public async Task<PagedResult<OrderViewInfo>> ListAsync(OrderSearchInput input)
        {
            ...
            WHERE 
                ...
                AND (
                    @SearchValue = ''
                    OR c.CustomerName COLLATE Latin1_General_CI_AI LIKE @SearchValue
        ...
        ";
                ...
                var parameters = new
                {
                    input.Status,
                    input.CustomerId,
                    input.DateFrom,   // 🔥 đúng tên
                    input.DateTo,     // 🔥 đúng tên
